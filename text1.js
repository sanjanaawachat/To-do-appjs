...
var largecontainer = document.getElementsByClassName("largecontainer")[0];
card1.addEventListener("click", () => {
  document.getElementsByClassName("pop-up")[0].style.display = "flex";
  largecontainer.className = "not_show";
});
...
addCard1.addEventListener("click", () => {
  ...
  largecontainer.className = "no_blur";
});
...
function createObj(card_heading) {
  document.getElementById("title_heading").style.display = "none";
  var obj = {
    title: card_heading,
    id: Date.now(),
    subtask,
...
function deleteCard(value) {
  ...
  if (arr_card_set.size == 0) {
    document.getElementById("title_heading").style.display = "block";
  }
}
